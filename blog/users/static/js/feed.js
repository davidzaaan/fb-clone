...
// Create a post box
const modalBtn = document.querySelector(".create_post__btn");

const modalBg = document.querySelector(".modal-bg");

const modalClose = document.querySelector(".create_post__close");

// Textareas auto sizing
const commentTextArea = document.querySelectorAll(".comment_text");

/*********** Function that closes any flashing messages ***************/
const closeMessages = () => {
...
/************ End of function that closes any flashing messages ****************/
...
function like(post_id, likedById) {
    ...
    if (!csrfToken) {
        return console.log("NO CSRF WAS GIVEN");
    }
...
function comment(postId, commentedById, commentContent) {
    ...
    fetch(resourceLink, init)
        ...
        .then(data => {
            ...
            alert("Your comment was made successfully!");
        });
...
// End of Comment was made functionality
